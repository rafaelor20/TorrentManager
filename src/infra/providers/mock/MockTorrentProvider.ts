...
export class MockTorrentClient implements TorrentClient {
  ...
  private mockTorrents: Torrent[] = [
    ...
    {
      id: 'mock-torrent-002',
      hash: 'mock-torrent-002',
      name: 'Open Source Linux Distribution ISO',
      size: 1024 * 1024 * 1024 * 2.8,
      progress: 1.0,
      status: 'completed',
      downloadSpeed: 0,
      uploadSpeed: 512 * 1024,
      category: 'Software / ISO',
    },
    {
      id: 'mock-torrent-003',
      hash: 'mock-torrent-003',
      name: 'Blender Open Movie 4K Remaster',
      size: 1024 * 1024 * 1024 * 12.4,
      progress: 0.35,
      status: 'downloading',
      downloadSpeed: 8 * 1024 * 1024,
      uploadSpeed: 1 * 1024 * 1024,
      eta: 1800,
      category: 'Filmes & Vídeos',
    },
  ];
